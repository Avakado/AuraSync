...
import VibrationCalculator from "./components/VibrationCalculator";
    ...
    <>
      {isLoading ? (
        ...
        <div className="w-full bg-bg text-text-primary min-h-screen relative overflow-x-hidden selection:bg-accent-dark/40 selection:text-white">
          ...
          <Hero onOpenInfo={handleOpenInfo} />

          {/* Interactive Calculator Anchor */}
          <div className="bg-bg py-16 border-t border-stroke relative z-10" id="calculator-section">
            <div className="max-w-[1200px] mx-auto px-6 md:px-10 lg:px-16 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
              <div className="lg:col-span-5 space-y-5 select-none text-center lg:text-left">
                <div className="flex justify-center lg:justify-start items-center gap-3">
                  ...
                  <span className="text-[10px] font-mono tracking-widest text-accent-light uppercase">NEURAL HARMONIZING</span>
                </div>
                ...
                <h2 className="text-4xl md:text-5xl font-sans text-text-primary leading-tight uppercase font-light">
                  ...
                  <span className="font-display italic text-accent-light lowercase">*frequency*</span>
                </h2>
                
                <p className="text-xs md:text-sm text-muted leading-relaxed max-w-md mx-auto lg:mx-0 font-light">
                  Our lightweight cognitive index interprets current energetic alignment levels, mapping them against desired neuro-plastic manifestation goals using Gemini deep analysis algorithms.
                </p>
                
                <div className="flex flex-col sm:flex-row gap-3 pt-4 justify-center lg:justify-start">
                  <button
                    onClick={() => handleOpenInfo("calibrator-blueprint")}
          ...
          <SelectedWorks onOpenInfo={handleOpenInfo} />

          {/* Section 4: Journal */}
          <Journal onOpenInfo={handleOpenInfo} />

          {/* Section 5: Explorations (Parallax Gallery) */}
          <Explorations onOpenInfo={handleOpenInfo} />

          {/* Section 6: Stats */}
          <Stats onOpenInfo={handleOpenInfo} />

          {/* Section 7: Contact / Footer */}
          <ContactFooter />

          {/* Unified Detail Page Modal Drawer */}
          <InfoPageModal 
            sectionId={activeInfoSection || ""}
            isOpen={activeInfoSection !== null}
